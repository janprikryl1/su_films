...
type Props = {
    results: DBScanResult | null;
    selectedCluster: number | null;
}

export const DbScanDetails:FC<Props> = ({results, selectedCluster}) => {
    ...
    if (selectedCluster !== null && results) {
        return (
            <div className="mt-10">
                <h4 className="text-xl font-semibold mb-3">Filmy ve shluku {selectedCluster}</h4>
